...
gsfId = 3959379712437752988
authSubToken = 'g.a000gwh950mXeymW-AM0IGpJtOPPL4w_PPe0Yga_DTwu94FBj2jLvXRpn-d809aNBEOwGIeJtAACgYKAcESAQASFQHGX2Mi36Vn68yksXgIo-skkEbD0xoVAUF8yKq5r_gWHEgXPyPzeoJssiHH0076'
server = GooglePlayAPI("en_US", "UTC", "wetekplay2", None)

# LOGIN
print("\nLogin with ac2dm token and gsfId saved\n")
server.login(None, None, gsfId, authSubToken)
# server.login("yaoyangding.work@gmail.com", "xzqcqekgovndxvik", None, None)
# server.login( None, None, gsfId, authSubToken)
...
# DOWNLOAD
docid = "com.canal.android.canal"
# server.log(docid)
print("\nAttempting to download {}\n".format(docid))
fl = server.download(docid)
with open(docid + "_tv" + ".apk", "wb") as apk_file:
